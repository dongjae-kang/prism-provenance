...
**Pre-launch backfill 작업 (v3 신규, 5/24~5/30):**
...
**Backfill 운영 부담 (3일 × 큐레이터 팀):** lead Jack ~3시간/일 + approver rotation 적용. burn-out risk → 이 backfill 기간 동안 정상 daily 5장은 4장으로 일시 축소 가능.
...
**Version**: v3.0 (with Hook Layer)
**Last updated**: 2026-05-06 (NYC, hook layer integrated)
**Authors**: Jack Kang (강동재) + Claude (writing assist, all decisions Jack-led)
**Source decisions**: 2026-05-05 [[김재훈]] 콜 (1.5h, KST 14:24~15:53) + 2026-05-05 [[김현미]] 1차 PRD 인계 미팅 (KST 16:00~) + 2026-05-06 hook layer brainstorm session (Jack push back: 2030 secondary target felt pull)
